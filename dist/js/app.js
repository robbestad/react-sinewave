...
React.renderComponent(FastSin(null), document.getElementById('fastsin'));

},{"./components/fastsin.jsx":147,"./components/mycomponent.jsx":148,"react":146}],2:[function(require,module,exports){
...
var React = require('react'),
    ...
    FastSin = React.createClass({displayName: 'FastSin',
        ...
        render: function() {
            ...
            return (
                React.DOM.div({ref: "myDiv", style: divStyle}, 
                    divs
                )
            )
        }
